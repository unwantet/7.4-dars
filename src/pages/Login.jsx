...
export default function Login() {
    return(
      ...
      <div class="wrapper mb-10">
        ...
        <div className="mt-5">
          <button className="btn btn-neutral w-full mb-3 text-xl" type="submit">Login</button>
          <button className="btn btn-active w-full mb-3 text-xl" type="submit">Guest user</button>
          <button className="btn btn-primary w-full mb-3" type="button" >
          <FcGoogle/>
          </button>
        <p className="text-center"> You don't have a accaunt? <Link to="/register" className="link text-blue-400 text-lg">Register</Link></p>
        </div> 
        </Form>
      </div>
    </div>
