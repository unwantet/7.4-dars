...
export default function SingleProduct() {
    ...
    const {image ,title , description , price , company, colors} = product.attributes;
    ...
    return (
        <section className="align-content">
            <div className="text-md breadcrumbs">
                <ul>
                    ...
                    <li>
                        <Link to='/products' className="capitalize">products</Link>
                    </li>
                </ul>
            </div>
        {/* product */}
        ...
        <div className="mt-2">
            {colors.map((color)=>{
                return <button  
                key={color}
                className={`badge w-6 h-6 mr-2 ${ color == productColor  && 'border-2 border-black ' } }`}
